      ...
      for (int fingerIndex = 0; fingerIndex < N_FINGERS; fingerIndex++) {
        for (int jointIndex = 0; jointIndex < N_ACTIVE_BONES; jointIndex++) {
          ...
          int boneArrayIndex = fingerIndex * N_ACTIVE_BONES + jointIndex;
					...
					GameObject brushGameObject = new GameObject(gameObject.name + "_" + fingerIndex + "_" + jointIndex, typeof(CapsuleCollider), typeof(Rigidbody), typeof(InteractionBrushBone));
